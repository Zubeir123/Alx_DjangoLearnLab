...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('relationship_app', '0002_rename_auther_book_author_alter_librarian_library'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('librarian', 'Librarian'), ('member', 'Member'), ('admin', 'Admin')], max_length=20)),
